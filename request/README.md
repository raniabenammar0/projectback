...
```
cd existing_repo
git remote add origin https://gitlab.allence.cloud/clients-acp/codereview/requestservice.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.allence.cloud/clients-acp/codereview/requestservice/-/settings/integrations)
