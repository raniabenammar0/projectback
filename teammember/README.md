...
```
cd existing_repo
git remote add origin https://gitlab.allence.cloud/clients-acp/codereview/teammemberservice.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.allence.cloud/clients-acp/codereview/teammemberservice/-/settings/integrations)
